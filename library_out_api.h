...
#ifdef YLGAITLIB_EXPORTS
# define YLGAITLIB_APIp EXTERNC EXPORT
# define YLGAITLIB_APIm CDECL
# define YLGAITLIB_APIs NOEXCEPT
#else
# define YLGAITLIB_APIp EXTERNC IMPORT
# define YLGAITLIB_APIm CDECL
# define YLGAITLIB_APIs NOEXCEPT
#endif
